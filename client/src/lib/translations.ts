...
export const translations: TranslationCollection = {
  ...
  kn: {
    ...
    sidebar: {
      ...
      quizzes: 'ಪ್ರಶ್ನೋತ್ತರಗಳು',
      achievements: 'ಸಾಧನೆಗಳು',
      community: 'ಸಮುದಾಯ',
      helpCenter: 'ಸಹಾಯ ಕೇಂದ್ರ',
      studyStreak: 'ಅಧ್ಯಯನ ಸ್ಟ್ರೀಕ್',
      days: 'ದಿನಗಳು',
    },
  ...
  or: {
    ...
    sidebar: {
      ...
      myCourses: 'ମୋ କୋର୍ସଗୁଡ଼ିକ',
      quizzes: 'କ୍ୱିଜ୍',
      achievements: 'ଉପଲବ୍ଧିଗୁଡ଼ିକ',
      community: 'ସମ୍ପ୍ରଦାୟ',
      helpCenter: 'ସାହାଯ୍ୟ କେନ୍ଦ୍ର',
      studyStreak: 'ଅଧ୍ୟୟନ ଷ୍ଟ୍ରିକ୍',
      days: 'ଦିନ',
    },
