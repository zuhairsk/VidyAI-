...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-b from-primary-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      <div className="absolute top-4 right-4 flex items-center space-x-2">
        <select
          value={language}
          onChange={(e) => setLanguage(e.target.value as any)}
          className="appearance-none bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-md px-3 py-1.5 text-sm font-medium text-gray-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-primary-500"
        >
        ...
        >
          <span className="material-icons-round text-gray-800 dark:text-gray-200 dark:hidden">dark_mode</span>
          <span className="material-icons-round text-gray-200 hidden dark:block">light_mode</span>
        </Button>
      </div>

      <div className="w-full max-w-md">
        <Card className="bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden">
          <div className="relative h-32 decoration-glitter rounded-t-xl flex items-center justify-center">
            <div className="absolute inset-0 bg-gradient-to-r from-primary-600 to-secondary-500 opacity-90"></div>
            <h1 className="text-white text-3xl font-heading font-bold relative z-10 flex items-center">
              <span className="material-icons-round text-4xl mr-2 animate-bounce">school</span>
              VidyAI++
            </h1>
          </div>
